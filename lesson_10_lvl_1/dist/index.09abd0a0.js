...
})({"wOCbO":[function(require,module,exports) {
...
// input card holder
(0, _createPageJs.inputName).addEventListener("input", (event)=>{
    event.target.value = event.target.value.replace(/[^a-zа-яё ]/ig, "");
    (0, _createPageJs.cardNamePlate).textContent = event.target.value;
    if (event.target.value.length === 0) (0, _createPageJs.cardNamePlate).textContent = "Card Holder";
});
// input card number
...
(0, _createPageJs.inputExp).addEventListener("input", (event)=>{
    (0, _createPageJs.cardExpPlate).textContent = event.target.value = event.target.value.replace(/[^0-9]/g, "").replace(/^([2-9])$/g, "0$1").replace(/^(1{1})([3-9]{1})$/g, "0$1/$2").replace(/^0{1,}/g, "0").replace(/^([0-1]{1}[0-9]{1})([0-9]{1,2}).*/g, "$1/$2");
...
parcelHelpers.export(exports, "cardNamePlate", ()=>cardNamePlate);
parcelHelpers.export(exports, "inputNumber", ()=>inputNumber);
parcelHelpers.export(exports, "cardNumberPlate", ()=>cardNumberPlate);
parcelHelpers.export(exports, "inputExp", ()=>inputExp);
parcelHelpers.export(exports, "cardExpPlate", ()=>cardExpPlate);
parcelHelpers.export(exports, "inputCVV", ()=>inputCVV);
var _redom = require("redom");
// CREATE PAGE
// card plate at page top
const cardExpPlate = (0, _redom.el)("span.card__date", "MM/YY");
const cardNamePlate = (0, _redom.el)("span.card__name", "Card Holder");
const cardNumberPlate = (0, _redom.el)("span.card__number", "xxxx xxxx xxxx xxxx");
const cardPlate = (0, _redom.el)("div.credit-card", [
    cardNumberPlate,
    (0, _redom.el)("div.card__personal", [
        cardNamePlate,
        cardExpPlate
    ])
]);
// form
// name input
const labelName = (0, _redom.el)("label.form__label form__holder-label", {
    for: "name"
}, "Card Holder");
const inputName = (0, _redom.el)("input.input input__holder", {
    type: "text",
    id: "name",
    placeholder: "Name Surname"
});
const inputNameWrapper = (0, _redom.el)("div.form__input-wrap form__input-wrap_holder", [
    labelName,
    inputName
]);
// card number input
...
const inputNumberWrapper = (0, _redom.el)("div.form__input-wrap form__input-wrap_number", [
    labelNumber,
    inputNumber
]);
// exp date input
const labelExp = (0, _redom.el)("label.form__label form__date-label", {
    for: "date"
}, "Card Expiry");
const inputExp = (0, _redom.el)("input.input input__date", {
    type: "text",
    id: "date",
    placeholder: "__/__"
});
const inputExpWrapper = (0, _redom.el)("div.form__input-wrap form__input-wrap_date", [
    labelExp,
    inputExp
]);
// cvv input
...
const inputCVVWrapper = (0, _redom.el)("div.form__input-wrap form__input-wrap_cvv", [
    labelCVV,
    inputCVV
]);
// submit button
...
// page content
const wrapper = (0, _redom.el)("div.wrapper", (0, _redom.el)("div.card", [
    (0, _redom.el)("p.secure", "Secure Checkout"),
    cardPlate,
    form
]));
(0, _redom.setChildren)(document.body, wrapper);

},{"redom":"iahd6","@parcel/transformer-js/src/esmodule-helpers.js":"5K5Ju"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5K5Ju"}],"5K5Ju":[function(require,module,exports) {
...
},{}]},["wOCbO","83FZ8"], "83FZ8", "parcelRequire94c2")
