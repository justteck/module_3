...
// show card front
const showCardFront = ()=>creditcard.classList.remove("flipped");
// execute
// mask input number
...
name.addEventListener("input", (event)=>{
    ...
    if (event.target.value.length === 0) svgname.textContent = "CARD HOLDER";
});
// input exp date
expirationDate.addEventListener("input", (event)=>{
    expirationDateCard.textContent = event.target.value = event.target.value.replace(/[^0-9]/g, "").replace(/^([2-9])$/g, "0$1").replace(/^(1{1})([3-9]{1})$/g, "0$1/$2").replace(/^0{1,}/g, "0").replace(/^([0-1]{1}[0-9]{1})([0-9]{1,2}).*/g, "$1/$2");
    if (event.target.value.length === 0) expirationDateCard.textContent = "MM/YY";
});
// input card number
number.addEventListener("input", (event)=>{
    ...
    (0, _maskJs.mask).some(changeCard);
    if (event.target.value.length === 0) numberCard.textContent = "XXXX XXXX XXXX XXXX";
});
...
},{"credit-card-input-mask":"bO9Hm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./createPage.js":"eG6R6","./mask.js":"eNgwD"}],"bO9Hm":[function(require,module,exports) {
"use strict";
var RestrictedInput = require("5075882be7aa352e");
module.exports = RestrictedInput;

},{"5075882be7aa352e":"fPKQq"}],"fPKQq":[function(require,module,exports) {
"use strict";
var device_1 = require("6cfb3bb808e574d0");
var supportsInputFormatting = require("22d4b9a917259eb6");
var ios_1 = require("ddc5015bb39bcf23");
var android_chrome_1 = require("268f5050a1ae83cc");
var kitkat_chromium_based_webview_1 = require("a2df9ccc99327f72");
var ie9_1 = require("adf726fd227b7ce1");
var base_1 = require("49fd88ee07bf7de4");
var noop_1 = require("79bb93ed28f86860");
/**
...
},{"6cfb3bb808e574d0":"coyu0","22d4b9a917259eb6":"jxX5h","ddc5015bb39bcf23":"5VqXj","268f5050a1ae83cc":"6xmWb","a2df9ccc99327f72":"5JFC5","adf726fd227b7ce1":"1MWrj","49fd88ee07bf7de4":"dR402","79bb93ed28f86860":"fl4aQ"}],"coyu0":[function(require,module,exports) {
"use strict";
...
var isAndroid = require("777ec343f42f6d13");
// @ts-ignore
var isChromeOs = require("43e8da59a3acf626");
// @ts-ignore
var isChrome = require("51bf64550037f0a6");
// @ts-ignore
var isIos = require("916c272161267525");
exports.isIos = isIos;
// @ts-ignore
var isIE9 = require("c212c838b42a67c5");
exports.isIE9 = isIE9;
...
},{"777ec343f42f6d13":"jtldm","43e8da59a3acf626":"in5Dg","51bf64550037f0a6":"40nLK","916c272161267525":"kAfY0","c212c838b42a67c5":"7rUWx"}],"jtldm":[function(require,module,exports) {
module.exports = require("bc8a9f3314186ea7");

},{"bc8a9f3314186ea7":"94VUa"}],"94VUa":[function(require,module,exports) {
"use strict";
...
module.exports = require("e2a735b14d0bc9cd");

},{"e2a735b14d0bc9cd":"hO6nk"}],"hO6nk":[function(require,module,exports) {
"use strict";
...
module.exports = require("fc81679c228285ef");

},{"fc81679c228285ef":"8wlUP"}],"8wlUP":[function(require,module,exports) {
"use strict";
var isEdge = require("a541b19ccc0745c3");
var isSamsung = require("22d5807e9d35451c");
var isDuckDuckGo = require("2efea5cbf8b4f523");
var isOpera = require("cd5058a5b8a8288c");
var isSilk = require("33557a1e81c30d37");
module.exports = function isChrome(ua) {
    ua = ua || window.navigator.userAgent;
    return (ua.indexOf("Chrome") !== -1 || ua.indexOf("CriOS") !== -1) && !isEdge(ua) && !isSamsung(ua) && !isDuckDuckGo(ua) && !isOpera(ua) && !isSilk(ua);
};

},{"a541b19ccc0745c3":"eanR9","22d5807e9d35451c":"3YCCg","2efea5cbf8b4f523":"3J4Uq","cd5058a5b8a8288c":"5k0Nr","33557a1e81c30d37":"8i4Xu"}],"eanR9":[function(require,module,exports) {
"use strict";
...
module.exports = require("4a278ceecf3b4684");

},{"4a278ceecf3b4684":"7ULxF"}],"7ULxF":[function(require,module,exports) {
"use strict";
...
module.exports = require("332d8ff459867497");

},{"332d8ff459867497":"9wFUI"}],"9wFUI":[function(require,module,exports) {
"use strict";
...
"use strict";
var device_1 = require("8d3036c821278d39");
module.exports = function supportsInputFormatting() {
    // Digits get dropped in samsung browser
    return !device_1.isSamsungBrowser();
};

},{"8d3036c821278d39":"coyu0"}],"5VqXj":[function(require,module,exports) {
"use strict";
...
var base_1 = require("fd3524ffd2815be3");
var key_cannot_mutate_value_1 = require("d9608b297eb86b6d");
var input_selection_1 = require("f9f52b3770f9dfd9");
...
},{"fd3524ffd2815be3":"dR402","d9608b297eb86b6d":"cbCy3","f9f52b3770f9dfd9":"2gSp4"}],"dR402":[function(require,module,exports) {
"use strict";
var __extends = this && this.__extends || function() {
    var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || ({
...
var strategy_interface_1 = require("3c5cc3aa74994bab");
var key_cannot_mutate_value_1 = require("43d686b2d85fec7d");
var input_selection_1 = require("6e78543b64d62e87");
var is_backspace_1 = require("7dfd7f41bf97a3f");
var is_delete_1 = require("dcd8354e4ce0db10");
var formatter_1 = require("3f28190f5a18115a");
...
},{"3c5cc3aa74994bab":"eR489","43d686b2d85fec7d":"cbCy3","6e78543b64d62e87":"2gSp4","7dfd7f41bf97a3f":"bCGFT","dcd8354e4ce0db10":"aA9DZ","3f28190f5a18115a":"6kXTK"}],"eR489":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var input_selection_1 = require("28ecfab3bef3d0ca");
...
},{"28ecfab3bef3d0ca":"2gSp4"}],"2gSp4":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var parse_pattern_1 = require("8302925e4a30612c");
var is_backspace_1 = require("1276a198470a343b");
...
},{"8302925e4a30612c":"jx52n","1276a198470a343b":"bCGFT"}],"jx52n":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
var key_cannot_mutate_value_1 = require("30112765cd9cf8ee");
var base_1 = require("9dfab83096d17438");
var input_selection_1 = require("ac29c84d95387278");
...
},{"30112765cd9cf8ee":"cbCy3","9dfab83096d17438":"dR402","ac29c84d95387278":"2gSp4"}],"5JFC5":[function(require,module,exports) {
"use strict";
...
var android_chrome_1 = require("d3fddbbbcae9a740");
...
},{"d3fddbbbcae9a740":"6xmWb"}],"1MWrj":[function(require,module,exports) {
"use strict";
var __extends = this && this.__extends || function() {
    var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || ({
...
var base_1 = require("cd7799a043b93bd1");
var key_cannot_mutate_value_1 = require("ed950594124886ea");
var input_selection_1 = require("3364c3b8cf321b0d");
...
},{"cd7799a043b93bd1":"dR402","ed950594124886ea":"cbCy3","3364c3b8cf321b0d":"2gSp4"}],"fl4aQ":[function(require,module,exports) {
"use strict";
var __extends = this && this.__extends || function() {
    var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || ({
...
var strategy_interface_1 = require("dede4598a34fdddf");
...
},{"dede4598a34fdddf":"eR489"}],"gkKU3":[function(require,module,exports) {
...
},{}],"eG6R6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderPage", ()=>renderPage);
var _redom = require("redom");
var _cardSvgJs = require("./cardSvg.js");
// CREATE PAGE
// create card
const title = (0, _redom.el)("div.payment-title", (0, _redom.el)("h1", "Payment Information"));
const cardFront = (0, _redom.el)("div.front", (0, _redom.el)("div#ccsingle"));
const cardBack = (0, _redom.el)("div.back");
cardBack.insertAdjacentHTML("beforeend", (0, _cardSvgJs.cardSvgBack));
cardFront.insertAdjacentHTML("beforeend", (0, _cardSvgJs.cardSvgFront));
const card = (0, _redom.el)("div.creditcard", [
    cardFront,
    cardBack
]);
const cardContainer = (0, _redom.el)("div.container", card);
// create form
// name field
const nameLabel = (0, _redom.el)("label", {
    for: "name"
}, "Name");
const nameInput = (0, _redom.el)("input#name", {
    maxlength: "20",
    type: "text"
});
const nameContainer = (0, _redom.el)("div.field-container", [
    nameLabel,
    nameInput
]);
// card number field
const numberLabel = (0, _redom.el)("label", {
    for: "cardnumber"
}, "Card Number");
const numberInput = (0, _redom.el)("input#cardnumber", {
    inputmode: "numeric",
    type: "text"
});
const numberContainer = (0, _redom.el)("div.field-container", [
    numberLabel,
    numberInput
]);
numberContainer.insertAdjacentHTML("beforeend", (0, _cardSvgJs.paymentSystem));
// expiration date field
const expLabel = (0, _redom.el)("label", {
    for: "expirationdate"
}, "Expiration (mm/yy)");
const expInput = (0, _redom.el)("input#expirationdate", {
    inputmode: "numeric",
    type: "text"
});
const expContainer = (0, _redom.el)("div.field-container", [
    expLabel,
    expInput
]);
// cvv field
const cvvLabel = (0, _redom.el)("label", {
    for: "securitycode"
}, "Security Code");
const cvvInput = (0, _redom.el)("input#securitycode", {
    inputmode: "numeric",
    type: "text"
});
const cvvContainer = (0, _redom.el)("div.field-container", [
    cvvLabel,
    cvvInput
]);
...
},{"redom":"iahd6","./cardSvg.js":"5AZs8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5AZs8":[function(require,module,exports) {
/* eslint-disable max-len */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cardSvgFront", ()=>cardSvgFront);
parcelHelpers.export(exports, "cardSvgBack", ()=>cardSvgBack);
parcelHelpers.export(exports, "paymentSystem", ()=>paymentSystem);
const cardSvgFront = `<svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<g id="Front">
  ...
  <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">CARD HOLDER</text>
    ...
    <g>
      ...
      <g>
        <path class="st12" d="M125.5,130.8c-10.2,0-18.5-8.3-18.5-18.5c0-4.6,1.7-8.9,4.7-12.3c-3-3.4-4.7-7.7-4.7-12.3
          ...
          c3.1-3.2,4.8-7.4,4.8-11.8C142.4,78.4,134.8,70.8,125.5,70.8z"/></g><g><rect x="82.8" y="82.1" class="st12" width="25.8" height="1.5"/></g><g><rect x="82.8" y="117.9" class="st12" width="26.1" height="1.5"/></g><g><rect x="142.4" y="82.1" class="st12" width="25.8" height="1.5"/></g><g><rect x="142" y="117.9" class="st12" width="26.2" height="1.5"/></g></g></g></g><g id="Back"></g></svg>`;
const cardSvgBack = `<svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
          <g id="Front">
          ...
          C0,17.9,17.9,0,40,0z"/>
            ...
            <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">CARD HOLDER</text>
          </g>
        </svg>`;
const paymentSystem = `<svg id="ccicon" class="ccicon" width="750" height="471" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg"
xmlns:xlink="http://www.w3.org/1999/xlink"></svg>`;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eNgwD":[function(require,module,exports) {
/* eslint-disable max-len */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["56Vnr","4pp4s"], "4pp4s", "parcelRequire3f2e")
